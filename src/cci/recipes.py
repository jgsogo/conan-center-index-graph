...
def get_recipe_list(cci_repo: Repository,
    ...
    if draft_folder:
        for recipe in get_draft_recipes(draft_folder, explode_options=explode_options):
...
def get_draft_recipes(draft_folder: cci.types.PATH, explode_options: bool = False):
